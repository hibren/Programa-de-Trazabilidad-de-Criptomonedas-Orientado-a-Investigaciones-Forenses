...
export const getColumnsDirecciones = () => [
  {
    ...
    cell: ({ row }) => (
      <span className="font-mono text-xs">{row.getValue("direccion")}</span>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      // Opción 1: Badge con icono y colores
      const getRiskBadge = () => {
        switch (riesgo) {
          case "bajo":
            return (
              <div className="inline-flex items-center px-2.5 py-1 rounded-full bg-green-100 border border-green-200">
                ...
                <span className="text-xs font-medium text-green-800">Bajo</span>
              </div>
            )
          case "medio":
            return (
              <div className="inline-flex items-center px-2.5 py-1 rounded-full bg-yellow-100 border border-yellow-200">
                ...
                <span className="text-xs font-medium text-yellow-800">Medio</span>
              </div>
            )
          case "alto":
            return (
              <div className="inline-flex items-center px-2.5 py-1 rounded-full bg-red-100 border border-red-200">
                ...
                <span className="text-xs font-medium text-red-800">Alto</span>
              </div>
            )
          default:
            return (
